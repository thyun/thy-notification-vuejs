<template>
    <main role="main" class="container">
        ...
        <form class="needs-validation" novalidate v-on:submit.prevent="updateTarget">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="phone"
                           placeholder="Phone number list (ex) 01230004001 01230004002">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="email"
                           placeholder="Email address list (ex) aaaa@example.com bbbb@example.com">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="slack" placeholder="Slack webhook url">
                    <span class="text-danger"></span>
